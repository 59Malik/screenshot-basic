...
var codes = __webpack_require__(79)
...
var typer = __webpack_require__(78)
...
var unpipe = __webpack_require__(152)
...
var zlib = __webpack_require__(153)
...
var expand = __webpack_require__(167)
...
var deprecate = __webpack_require__(85)('http-errors')
var setPrototypeOf = __webpack_require__(88)
var statuses = __webpack_require__(6)
var inherits = __webpack_require__(11)
var toIdentifier = __webpack_require__(15)
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(86)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(87)
})
...
var deprecate = __webpack_require__(34)('http-errors')
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(91)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(92)
})
...
const Promise = __webpack_require__(115)
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(121);
...
var raw = __webpack_require__(17);
...
var globSync = __webpack_require__(170)
var common = __webpack_require__(51)
var alphasort = common.alphasort
var alphasorti = common.alphasorti
var setopts = common.setopts
var ownProp = common.ownProp
var inflight = __webpack_require__(171)
var util = __webpack_require__(1)
var childrenIgnored = common.childrenIgnored
var isIgnored = common.isIgnored

var once = __webpack_require__(53)
...
var wrappy = __webpack_require__(52)
...
const { Readable, Writable } = __webpack_require__(3);
...
var v1 = __webpack_require__(61);
var v4 = __webpack_require__(62);
...
const isGeneratorFunction = __webpack_require__(63);
const debug = __webpack_require__(64)('koa:application');
const onFinished = __webpack_require__(30);
const response = __webpack_require__(70);
const compose = __webpack_require__(83);
const context = __webpack_require__(84);
const request = __webpack_require__(102);
const statuses = __webpack_require__(6);
const Emitter = __webpack_require__(5);
const util = __webpack_require__(1);
const Stream = __webpack_require__(3);
const http = __webpack_require__(9);
const only = __webpack_require__(14);
const convert = __webpack_require__(113);
const deprecate = __webpack_require__(119)('koa');
const { HttpError } = __webpack_require__(31);
...
var debug = __webpack_require__(38)('koa-router');
var compose = __webpack_require__(37);
var HttpError = __webpack_require__(123);
...
const buddy = __webpack_require__(131);
const forms = __webpack_require__(157);
const symbolUnparsed = __webpack_require__(164);
...
var fs = __webpack_require__(2);
var ncp = __webpack_require__(165).ncp;
var path = __webpack_require__(0);
var rimraf = __webpack_require__(166);
var mkdirp = __webpack_require__(172);
...
/* harmony import */ var _citizenfx_http_wrapper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(54);
/* harmony import */ var _citizenfx_http_wrapper__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_citizenfx_http_wrapper__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(55);
...
/* harmony import */ var koa__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(56);
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(57);
...
/* harmony import */ var koa_body__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(58);
...
/* harmony import */ var mv__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59);
/* harmony import */ var mv__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(mv__WEBPACK_IMPORTED_MODULE_6__);
...
const app = new koa__WEBPACK_IMPORTED_MODULE_3__();
const router = new koa_router__WEBPACK_IMPORTED_MODULE_4__();
class UploadData {
}
const uploads = {};
router.post('/upload/:token', (ctx) => __awaiter(undefined, void 0, void 0, function* () {
    ...
    if (uploads[tkn] !== undefined) {
        ...
        if (f) {
            if (upload.fileName) {
                mv__WEBPACK_IMPORTED_MODULE_6__(f.path, upload.fileName, (err) => {
                    if (err) {
                ...
                fs__WEBPACK_IMPORTED_MODULE_2__["readFile"](f.path, (err, data) => {
                    if (err) {
                        finish(err.message, null);
                        return;
                    }
                    fs__WEBPACK_IMPORTED_MODULE_2__["unlink"](f.path, (err) => {
...
app.use(koa_body__WEBPACK_IMPORTED_MODULE_5__({
    patchKoa: true,
    multipart: true,
}))
    .use(router.routes())
    .use(router.allowedMethods());
Object(_citizenfx_http_wrapper__WEBPACK_IMPORTED_MODULE_0__["setHttpCallback"])(app.callback());
// Cfx stuff
const exp = global.exports;
exp('requestClientScreenshot', (player, options, cb) => {
    const tkn = Object(uuid__WEBPACK_IMPORTED_MODULE_1__["v4"])();
...
try {
  var supportsColor = __webpack_require__(28);
...
const contentDisposition = __webpack_require__(71);
const getType = __webpack_require__(73);
const onFinish = __webpack_require__(30);
const escape = __webpack_require__(77);
const typeis = __webpack_require__(13).is;
const statuses = __webpack_require__(6);
const destroy = __webpack_require__(80);
const assert = __webpack_require__(10);
const extname = __webpack_require__(0).extname;
const vary = __webpack_require__(81);
const only = __webpack_require__(14);
const util = __webpack_require__(1);
const encodeUrl = __webpack_require__(82);
const Stream = __webpack_require__(3);
...
const mimeTypes = __webpack_require__(12);
const LRU = __webpack_require__(76);
...
const util = __webpack_require__(1);
const createError = __webpack_require__(31);
const httpAssert = __webpack_require__(90);
const delegate = __webpack_require__(97);
const statuses = __webpack_require__(6);
const Cookies = __webpack_require__(98);
...
var callSiteToString = __webpack_require__(32).callSiteToString
var eventListenerCount = __webpack_require__(32).eventListenerCount
var relative = __webpack_require__(0).relative
...
var createError = __webpack_require__(33)
var eql = __webpack_require__(94)
...
var deprecate = __webpack_require__(99)('cookies')
var Keygrip = __webpack_require__(100)
...
var compare = __webpack_require__(101)
var crypto = __webpack_require__(8)
...
const URL = __webpack_require__(16).URL;
const net = __webpack_require__(103);
const accepts = __webpack_require__(104);
const contentType = __webpack_require__(110);
const stringify = __webpack_require__(16).format;
const parse = __webpack_require__(111);
const qs = __webpack_require__(36);
const typeis = __webpack_require__(13);
const fresh = __webpack_require__(112);
const only = __webpack_require__(14);
const util = __webpack_require__(1);
...
var Negotiator = __webpack_require__(105)
var mime = __webpack_require__(12)
...
function loadModule(moduleName) {
  ...
  switch (moduleName) {
    ...
    case 'language':
      ...
      break;
    case 'mediaType':
      module = __webpack_require__(109);
      break;
    default:
...
const co = __webpack_require__(114)
const compose = __webpack_require__(37)
...
module.exports = __webpack_require__(116)().Promise
...
module.exports = __webpack_require__(117)(global, loadImplementation);
...
function loadImplementation(implementation){
  ...
  if(shouldPreferGlobalPromise(implementation)){
    ...
    var lib = __webpack_require__(118)(implementation)
    impl = {
...
var debug = __webpack_require__(38)('koa-router');
var pathToRegExp = __webpack_require__(127);
var uri = __webpack_require__(129);
...
(function (root, factory) {
  ...
  if ( true && module.exports) {
    // Node
    module.exports = factory(__webpack_require__(40), __webpack_require__(41), __webpack_require__(42));
  } else if (true) {
    // AMD. Register as an anonymous module.
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(40), __webpack_require__(41), __webpack_require__(42)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
exports.json = __webpack_require__(43);
exports.form = __webpack_require__(47);
exports.text = __webpack_require__(49);
...
var typeis = __webpack_require__(13);
...
var bomHandling = __webpack_require__(135),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(136); // Lazy load all encoding definitions.
...
module.exports = {
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(18).concat(__webpack_require__(45)) },
        gb18030: function() { return __webpack_require__(147) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(46).concat(__webpack_require__(149)) },
...
var IncomingForm = __webpack_require__(158).IncomingForm;
...
var util = __webpack_require__(1),
    path = __webpack_require__(0),
    File = __webpack_require__(159),
    MultipartParser = __webpack_require__(160).MultipartParser,
    QuerystringParser = __webpack_require__(161).QuerystringParser,
    OctetParser       = __webpack_require__(162).OctetParser,
    JSONParser = __webpack_require__(163).JSONParser,
...
var concatMap = __webpack_require__(168);
var balanced = __webpack_require__(169);
